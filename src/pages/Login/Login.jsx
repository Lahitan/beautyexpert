	...
	return (
		<div className="bg-primary-brand flex flex-col min-h-screen justify-center items-center">
			<div className=" w-[22.5rem] lg:w-[35.18rem] ">
				<div>
					<h2 className="lg:text-xl font-bold text-center mb-1">Log into Beauty Xpats</h2>
				</div>

				<div className="text-center mb-8" >
					<span>Don’t have an account?</span><span className=" font-semibold"><Link> Sign up</Link></span>
				</div>

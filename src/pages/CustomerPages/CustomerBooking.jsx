...
import girl from "../../assets/halfBraid.png";
		...
		<div className="bg-primary-brand p-10">
			...
			<div className=" flex flex-col-2 my-8 gap-4">
				...
				<div className=" w-6/12">
					...
					<div className="my-8 mx-4">
						<div className=" flex items-center font-bold justify-between">
							<div>
								<h6>TJ'S Unisex Salon</h6>
								<span className=" font-thin text-xs">
									56, Surulere, Lawanson
								</span>
							</div>
							<img
								src={greyHeart}
									...
									<div className="text-xs ">
										<div className=" flex flex-col-2 items-center justify-between">
											<div className=" flex flex-col-2 items-center mx-2">
												...
												<div>
													<Link to={"/ScheduleAppointment"} className=" ">
														<button className="btn btn-active btn-xs btn-accent">
															Book
														</button>
													</Link>
												</div>
						...
						<div>
							...
							<div>
								<Link to={"/CustomerBooking"} className="  ">
									<button className=" w-[100%] btn btn-xs btn-active btn-accent my-4 text-primary-brand ">
										VIEW MORE
									</button>
								</Link>
							</div>
								...
								<div>
									...
									<div className=" flex items-center gap-4 my-6">
										...
										<div className="">
											...
											<p>
												Amope is a braiding genius. She took the time to
												understand what style. I wanted and created neat,
												beautiful and long-lasting Ghana-weaving.
											</p>
										</div>
									</div>
									{/* paragraph 2 */}
									<div className=" flex items-center gap-4 my-6">
										...
										<div className="">
											...
											<p>
												Shes's the best hairstylist I've ever been to. She did a
												fantastic job on my gele for a wedding{" "}
											</p>
										</div>
									</div>
									{/* paragraph 3 */}
									<div className=" flex items-center gap-4 my-6">
										...
										<div className="">
											...
											<p>
												The hairstylist was welcoming and professional. Just a
												snall thing, maybe offering a wide selection of hair
												products for naturalists would have been better
											</p>
										</div>
									</div>
									{/* paragraph 4 */}
									<div className=" flex items-center gap-4 my-6">
										...
										<div className="">
											...
											<p>
												The appointment for my locs retwist was good, but i felt
												like it could been a bit quicker. Maybe having an
												assistant to help could speed things up? Still, the
				...
				<div className=" w-6/12 ">
					...
					<div className=" mb-4">
						<img
							src={map}
							alt="picture of a map of lagos state"
							className="w-[100%]"
						/>
					</div>
					{/* about us */}
					<div>
						<h6 className=" w-6/12 m-auto mb-4 font-bold text-center ">
							About Us
						</h6>
						<div className=" text-center font-medium mb-4">
							<p>
								I am the proud owner of TJ's Unisex Salon, located in the
								beautiful city of Lagos at 56, Surulere. I specialise in all
								kinds of braids, wigging & revamping, cornrows & weave, washing
								& drying, deep conditioning treatment, retouching, twists &
								dreadlock, hair extension, styling & ponytail, stretching &
								installation.
								<br />
								My main focus is your hair health. I am very well diverse on
								multiple hair texture. Looking forward to rendering my servicing
								you
							</p>
						</div>
						<div className=" m-2">
			...
			<div>
				...
				<div className="flex mt-8 lg:col-span-2 items-center justify-center flex-grow">
					<p className=" text-base font-bold mr-5 text-secondary-brand">
						Follow us:
					</p>
					{/*social media icons  */}

		...
		<div>
			<div className=" bg-primary-brand">
				...
				<div style={background} className=" ">
					...
					<div className="flex flex-col items-center justify-center mt-8">
						...
						<div className=" w-[23rem] lg:w-[52rem]  text-center">
							...
							<Link to={"/"} className=" ">
								<button className="  bg-tertiary-brand btn btn-circle btn-sm px-16 btn-neutral mb-8">
									Book_an_expert
								</button>
							</Link>
						...
						<div className=" hidden  w-[42rem] bg-[#FFE9E9] lg:flex flex-col items-center justify-center p-4 rounded-lg mt-32 xl:mt-52">
							...
							<div className="flex gap-3 pb-3">
								...
								<Link to={"/CustomerServicesBarber"}>
									<img src={Home_img_2} alt="" />
								</Link>
								<Link to={"/CustomerServicesNail"}>
									<img src={Home_img_3} alt="" />
								</Link>
								<Link to={"/CustomerServicesMakeup"}>
									<img src={Home_img_4} alt="" />
								</Link>
								<Link to={"/CustomerServicesFashion"}>
				...
				<div className="w-[90%] mx-auto">
					...
					<div className=" mt-16">
						<h2 className=" text-black font-bold text-2xl mb-6">Top Ratings</h2>
						...
						<div className=" w-[20rem] lg:w-[28.87rem] flex flex-col  bg-[#12522D] rounded-2xl">
							...
							<div className=" p-4 flex flex-col">
								...
								<p className=" w-[16rem] lg:w-[25.25rem] text-white mb-2">
									Looking for your next appointment with a hair stylist, barber
									or nail technician?
								</p>
								<p className=" w-[16rem] lg:w-[23.25rem] text-white mb-6">
									Search through our beauty expert’s portfolio and schedule your
									appointment with your best.
								</p>
								<div className="flex justify-end">
									<Link to={"/ScheduleAppointment"} className=" ">
										<button className=" bg-tertiary-brand btn btn-circle btn-sm px-20 btn-neutral">
											Book_an_appointment
										</button>
									</Link>
								</div>
					...
					<div className="mt-20 flex flex-col items-center justify-center ">
						...
						<div className=" pb-48">
							<button
								...
								class="text-black bg-primary-brand  font-base rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center gap-1.5 "
								type="button"
							>
								Lagos <img src={dropdown} alt="" />
							</button>
							...
							<button
								...
								type="button"
							>
								Port-hacourt <img src={dropdown} alt="" />
							</button>
					...
					<div className="text-[#12522D] flex flex-col justify-center items-center">
						<div className="flex gap-3 lg:gap-6 items-center mb-10">
							<h3 className=" font-bold text-base lg:text-lg">Follow us:</h3>
						...
						<span className=" mb-6">
							© 2024 Beauty Xpats. All Rights Reserved.
						</span>
					</div>
				</div>
			</div>

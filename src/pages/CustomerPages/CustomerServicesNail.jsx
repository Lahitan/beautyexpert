...
import image1 from "../../assets/nail-2.png";
import image2 from "../../assets/nail-3.png";
import image3 from "../../assets/nail-1.png";
import image4 from "../../assets/nail-4.png";
...
const CustomerServicesNail = () => {
     // calling from CustomersServicescard
    const arr = [
        {
            image: image1,
            title: "Royal Nails Art",
            stars: [..."1234"].map((each) => (
...
export default CustomerServicesNail

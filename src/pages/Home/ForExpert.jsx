...
const ForExpert = ({
	...
	return (
		<div className="bg-primary-brand">
			...
			<div
				className={`${lgBackground} ${smBackground}  bg-no-repeat bg-center bg-cover   lg:h-[33.7rem] rounded-xl flex`}
			>
				<div className="text-left w-[39rem] m-6 text-white content-start">
					{/*---- For beauty text and styles-----*/}

					<h5 className=" my-4 text-sm sm:text-lg lg:my-9 lg:text-2xl font-semibold font-montserrat">
						{h5}
					</h5>
					...
					<h3 className="text-xl w-[14rem] mb-4 font-semibold sm:text-2xl sm:w-[28rem] lg:w-[40rem] lg:text-4xl lg:font-bold lg:mb-8">
						<span>{h3} </span>
						<span className=" bg-green-circles bg-no-repeat bg-center bg-cover">
							{highlighted}
						</span>{" "}
						{h3Contd && <span>{h3Contd}</span>}
					</h3>
